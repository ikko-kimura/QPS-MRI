...
StudyFolder="/home/ikimura/work/PRELIMINARY3_Vida/data" #Location of Subject folders (named by subjectID)
...
TaskList=""
TaskList+="${Tasklist} ${type}_REST${sess}_AP"

#TaskList+="${Tasklist} 7_BOLD_MOTOR1_PA"  #Include space as first character
#TaskList+="${Tasklist} 9_BOLD_MOTOR2_PA"
#TaskList+="${Tasklist} 11_BOLD_REST_PA"
...
for Subject in $Subjlist ; do
  ...
  for fMRIName in $TaskList ; do
    ...
    # just eextract required info
    arr=( `ls ${StudyFolder}/${Subject}/RawData_${type}/NIFTI/*REST${sess}*.nii` )	
    fMRITimeSeries=${arr[0]}
    ...
    SpinEchoPhaseEncodeNegative=`ls ${StudyFolder}/${Subject}/RawData_${type}/NIFTI/*_SEField${sess}_AP.nii`
	...
	# Set to NONE if using regular FIELDMAP
    SpinEchoPhaseEncodePositive=`ls ${StudyFolder}/${Subject}/RawData_${type}/NIFTI/*_SEField${sess}_PA.nii`
