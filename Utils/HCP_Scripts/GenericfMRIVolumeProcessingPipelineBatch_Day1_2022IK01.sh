...
TaskList=""
TaskList+="${Tasklist} MOTOR1_AP"  #Include space as first character
TaskList+="${Tasklist} MOTOR2_AP"
...
for Subject in $Subjlist ; do
  ...
  for fMRIName in $TaskList ; do
    ...
    arr=( `ls ${StudyFolder}/${Subject}/RawData/NIFTI/*${fMRIName:0:-3}*.nii` )	
    ...
    SpinEchoPhaseEncodeNegative=`ls ${StudyFolder}/${Subject}/RawData/NIFTI/*_SEField*AP.nii`
	...
	# Set to NONE if using regular FIELDMAP
    SpinEchoPhaseEncodePositive=`ls ${StudyFolder}/${Subject}/RawData/NIFTI/*_SEField*PA.nii`
