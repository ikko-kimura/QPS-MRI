...
StudyFolder="/home/ikimura/work/VIDA_2021IK04/qps5" #Location of Subject folders (named by subjectID)
#Subjlist="KS000MS KS017KH KS041SS KS047KY" #Space delimited list of subject IDs
Subjlist="KS041SS"
...
do
	LevelOneTasksList="${TaskName}1_AP@${TaskName}2_AP" #Delimit runs with @ and tasks with space
	LevelOneFSFsList="${TaskName}1_AP@${TaskName}2_AP" #Delimit runs with @ and tasks with space
	...
	TemporalFilter="160" #Use 2000 for linear detrend, 200 is default for HCP task fMRI
