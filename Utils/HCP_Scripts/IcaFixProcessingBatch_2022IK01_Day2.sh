...
DEFAULT_STUDY_FOLDER="/home/ikimura/work/PRELIMINARY3_Vida/data"
DEFAULT_SUBJECT_LIST="KS000MS"
DEFAULT_ENVIRONMENT_SCRIPT="/project/proj_shibusawa/kimura/2021IK01/scripts/HCP_Scripts/SetUpHCPPipeline.sh"
...
main() {
	...
	fMRINames="${type}_REST1_AP@${type}_REST2_AP"
	...
	ConcatNames=""
	#ConcatNames="BOLD_REST1_2.4mmiso_AP_PA"  ## Use space (or @) to separate concatenation groups
